...
def standardize_and_write_chunks(input_file, output_file, global_mean, chunk_size):
    ...
    with open(output_file, 'w') as f:
        ...
        while batches:
            ...
            df_chunk = df_chunk.with_columns((pl.col('event_stdv') / global_mean).alias('event_stdv'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--chunk_size', type=int, default=1000000, help='Number of rows per chunk for processing')
    ...
    standardize_and_write_chunks(args.input_file, args.output_file, global_mean, args.chunk_size)